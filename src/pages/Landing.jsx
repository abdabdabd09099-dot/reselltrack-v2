...
const LANDING_CSS = `
  ...
  .lp-nav { display: flex; align-items: center; justify-content: space-between; padding: 20px 32px; position: sticky; top: 0; z-index: 50; background: rgba(255,255,255,0.92); backdrop-filter: blur(16px); border-bottom: 1px solid #E2E8F044; box-shadow: 0 1px 12px #0000000a; }
  .lp-hero { padding: 80px 32px 60px; text-align: center; max-width: 780px; margin: 0 auto; }
  .lp-display { font-family: 'DM Sans', sans-serif; font-size: clamp(36px, 6vw, 68px); font-weight: 800; line-height: 1.08; letter-spacing: -2px; color: #0F172A; }
  .lp-gold { color: #F5A623; }
  .lp-sub { font-size: clamp(15px, 2vw, 18px); color: #475569; line-height: 1.7; max-width: 520px; margin: 20px auto 0; }
  ...
  .lp-btn-ghost { background: transparent; color: #0F172A; border: 1px solid #E2E8F0; border-radius: 10px; font-weight: 600; font-size: 15px; cursor: pointer; font-family: inherit; transition: all .2s; padding: 14px 28px; background: transparent; color: #0F172A; border: 1px solid #E2E8F0; border-radius: 10px; font-weight: 600; font-size: 15px; cursor: pointer; font-family: inherit; transition: all .2s; }
  .lp-btn-ghost:hover { border-color: #F5A623; color: #F5A623; background: #F5A62308; }
  .lp-mockup { max-width: 860px; margin: 0 auto; padding: 0 24px 60px; }
  .lp-screen { background: #F8F9FC; border: 1px solid #E2E8F0; border-radius: 20px; overflow: hidden; box-shadow: 0 32px 80px #00000088, 0 0 0 1px #252C3F; }
  .lp-screen-bar { background: #F0F2F8; padding: 12px 16px; display: flex; align-items: center; gap: 8px; border-bottom: 1px solid #252C3F; }
  ...
  .lp-stat-card { background: #F0F2F8; border: 1px solid #E2E8F0; border-radius: 12px; padding: 14px; }
  ...
  .lp-feature-card { background: #F8F9FC; border: 1px solid #E2E8F0; border-radius: 16px; padding: 24px; transition: border-color .2s, transform .2s; }
  .lp-feature-card:hover { border-color: #F5A623aa; transform: translateY(-3px); }
  .lp-feature-icon { font-size: 28px; margin-bottom: 14px; }
  .lp-feature-title { font-family: 'DM Sans', sans-serif; font-size: 16px; font-weight: 700; color: #0F172A; margin-bottom: 8px; }
  .lp-feature-desc { font-size: 13px; color: #475569; line-height: 1.6; }
  .lp-demo-banner { max-width: 680px; margin: 0 auto 80px; padding: 0 24px; }
  .lp-demo-card { background: linear-gradient(135deg, #F8F9FC, #FFFFFF); border: 1px solid #F5A62344; border-radius: 20px; padding: 40px 36px; text-align: center; position: relative; overflow: hidden; }
...
const BAR_COLORS = ['#F5A62355','#F5A62377','#F5A62355','#F5A623','#F5A62377','#F5A623cc','#F5A623bb']
      ...
      <div className="lp">
        ...
        <nav className="lp-nav">
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontFamily: "'DM Sans',sans-serif", fontWeight: 700, fontSize: 16, color: '#0F172A' }}>
        ...
        <section className="lp-hero">
          <div style={{ display: 'inline-block', background: '#F5A62314', border: '1px solid #F5A62366', borderRadius: 20, padding: '5px 14px', fontSize: 12, color: '#F5A623', fontWeight: 600, marginBottom: 24, letterSpacing: .3 }}>
          ...
          <p style={{ fontSize: 12, color: '#94A3B8', marginTop: 16 }}>No credit card. No commitment. 2 free records to test.</p>
        </section>
        ...
        <div className="lp-mockup">
          <div className="lp-screen">
            <div className="lp-screen-bar">
              ...
              <span style={{ fontSize: 12, color: '#94A3B8', marginLeft: 8, fontFamily: 'JetBrains Mono, monospace' }}>reselltrack.app — Dashboard</span>
            </div>
            <div className="lp-screen-body">
              ...
              {/* Mini chart */}
              <div style={{ background: '#F0F2F8', border: '1px solid #252C3F', borderRadius: 12, padding: '14px 14px 10px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 6 }}>
                  {['Mon','Tue','Wed','Thu','Fri','Sat','Sun'].map(d => (
                    <span key={d} style={{ fontSize: 9, color: '#94A3B8', flex: 1, textAlign: 'center' }}>{d}</span>
                  ))}
                </div>
              </div>
            </div>
        ...
        <section className="lp-features">
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            <h2 style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 30, fontWeight: 800, color: '#0F172A', letterSpacing: '-1px', marginBottom: 10 }}>
        ...
        <div className="lp-demo-banner">
          <div className="lp-demo-card">
            ...
            <h3 style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 24, fontWeight: 800, color: '#0F172A', marginBottom: 12, letterSpacing: '-0.5px' }}>
        ...
        <div style={{ textAlign: 'center', padding: '24px', fontSize: 12, color: '#94A3B8', display: 'flex', flexDirection: 'column', gap: 10, alignItems: 'center' }}>
          <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <span style={{ color: '#94A3B8' }}>Data encrypted · No ads · No tracking</span>
            <span style={{ color: '#E2E8F0' }}>·</span>
            <span style={{ color: '#94A3B8' }}>🔒 Secured by Supabase</span>
          </div>
          <div style={{ color: '#E2E8F0' }}>ResellTrack © {new Date().getFullYear()} · Built for resellers worldwide</div>
        </div>
      </div>
    </>
  )
